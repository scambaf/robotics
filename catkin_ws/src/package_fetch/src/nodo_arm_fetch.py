...
#Importamos los mensajes de la acciÃ³n FollowJointTrajectory - Action y Goal
from control_msgs.msg import FollowJointTrajectoryAction, FollowJointTrajectoryGoal

#Importamos los mensajes de tipo JointTrajectory - JointTrajectoryPoint
from trajectory_msgs.msg import JointTrajectory, JointTrajectoryPoint

#Importamos math para convertir Grados a Radianes en la generaciÃ³n de las trayectorias del Brazo del robot
import math
...
#Creamos 6 trayectorias, para el movimiento del brazo robot, los valores de cada articulaciÃ³n estan dado en radianes
...
if __name__ == "__main__":
    ...
    trajectory.points[0].time_from_start = rospy.Duration(1.0) #Asignamos la duraciÃ³n de 1seg para iniciar
    ...
    arm_goal.goal_time_tolerance = rospy.Duration(0.0) #Asignamos la duraciÃ³n de 0seg como tiempo de tolerancia de nuestro objetivo

    rospy.loginfo("Setting positions...") #Imprimimos en pantalla 
    
    arm_client.send_goal(arm_goal) #Enviamos nuestro objetivo hacia el AcciÃ³n Server de nuestro robot Fetch
