...
let DoCarWashGoal = require('./DoCarWashGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class DoCarWashActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DoCarWashGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoCarWashActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DoCarWashGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DoCarWashGoal()
    }
...
module.exports = DoCarWashActionGoal;
