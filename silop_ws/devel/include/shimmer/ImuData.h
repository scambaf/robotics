// Generated by gencpp from file shimmer/ImuData.msg
// DO NOT EDIT!


#ifndef SHIMMER_MESSAGE_IMUDATA_H
#define SHIMMER_MESSAGE_IMUDATA_H
...
struct ImuData_
{
  ...
  typedef boost::shared_ptr< ::shimmer::ImuData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::shimmer::ImuData_<ContainerAllocator> const> ConstPtr;

}; // struct ImuData_

typedef ::shimmer::ImuData_<std::allocator<void> > ImuData;

typedef boost::shared_ptr< ::shimmer::ImuData > ImuDataPtr;
typedef boost::shared_ptr< ::shimmer::ImuData const> ImuDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::shimmer::ImuData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::shimmer::ImuData_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::shimmer::ImuData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::shimmer::ImuData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::shimmer::ImuData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::shimmer::ImuData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::shimmer::ImuData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::shimmer::ImuData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::shimmer::ImuData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::shimmer::ImuData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe51281446bd87292ULL;
  static const uint64_t static_value2 = 0xee13fc0bd970e6d5ULL;
};

template<class ContainerAllocator>
struct DataType< ::shimmer::ImuData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::shimmer::ImuData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::shimmer::ImuData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::shimmer::ImuData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::shimmer::ImuData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SHIMMER_MESSAGE_IMUDATA_H
