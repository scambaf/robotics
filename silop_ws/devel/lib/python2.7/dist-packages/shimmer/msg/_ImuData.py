...
"""autogenerated by genpy from shimmer/ImuData.msg. Do not edit."""
import sys
...
class ImuData(genpy.Message):
  _md5sum = "e51281446bd87292ee13fc0bd970e6d5"
  _type = "shimmer/ImuData"
...
float64 y
float64 z"""
  __slots__ = ['header','magnetic_field','magnetic_field_covariance','angular_velocity','angular_velocity_covariance','linear_acceleration','linear_acceleration_covariance']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','float64[9]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,magnetic_field,magnetic_field_covariance,angular_velocity,angular_velocity_covariance,linear_acceleration,linear_acceleration_covariance
